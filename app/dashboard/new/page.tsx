    ...
    >
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          {/* Hero — eligibility */}
          <section className="relative overflow-hidden" style={{ background: "linear-gradient(135deg, #ede9fe 0%, #f0f0ff 50%, #e8e4ff 100%)" }}>
              ...
              <div className="flex flex-col gap-8 lg:flex-row lg:items-center">
                ...
                <div className="flex flex-col items-center gap-3 -translate-x-40">
                  <div className="relative flex h-56 w-56 items-center justify-center">
                    ...
                    <div className="absolute inset-5 rounded-full border-2 border-dashed border-violet-300" />
                    <div className="absolute inset-10 rounded-full border-2 border-dashed border-violet-400" />
